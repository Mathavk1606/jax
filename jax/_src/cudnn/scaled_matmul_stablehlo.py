...
# DO NOT SUBMIT - update!
# If _enable_reduce_scatter(lhs, rhs), and one of the non contracting dimensions
# of the output (M or N) is sharded in the same way as the contracting dimension
# (K), return that output dimension along which to perform reduce-scatter.
